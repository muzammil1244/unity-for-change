...
<div className="w-full  flex relative justify-center py-4">
    ...
    <h1 className="font-bold text-xl border-b pb-2 flex gap-2 items-center  "> <IoIosLogIn/> Signin</h1>
</div>

<div className=" h-full  px-3 justify-center grid items-center gap-4 grid-cols-2">
    <div className=" col-end-2 flex flex-col  py-10 justify-around bg-white rounded-xl  px h-1/2">
...
<button className="w-full cursor-pointer py-2 bg-black hover:bg-black/50 rounded-xl text-white" onClick={handle_api_post_login}> {active_spinner?<div className="flex justify-center items-center">
 ...
 <div className="col-span-1 rounded-xl overflow-hidden grid grid-cols-2 gap-3 grid-rows-2 bg-white h-1/2">
...
<h1 onClick={set_register_active} className="flex items-center gap-2 cursor-pointer hover:text-gray-600 text-sm "><span className="text-gray-500">new </span>  register</h1>
</div>
